...
//	afterRenderObject = renderObject.reverse();
	...
	if (afterRenderObject.length < 1) {
		afterRenderObject.push(["updateDataFilter",[true],{"toDoFilter":{"sample":{"IFN":{"exact":["High","Low"]},"SNP":{"exact":Alleles_value}}}}]);
		afterRenderObject.push(["changeAttribute",["colorBy","SNP"]]);
		afterRenderObject.push(["groupSamples",[["IFN","SNP"]]]);
		afterRenderObject.push(["sortSamplesByCategory",[["IFN"]],{"sortDir":"ascending"}]);
...
//	afterRenderObject1 = renderObject.reverse();
	...
	if (afterRenderObject1.length < 1) {
		afterRenderObject1.push(["changeAttribute",["colorBy","IFN"]]);
		afterRenderObject1.push(["groupSamples",[["SNP","IFN"]]]);
		afterRenderObject1.push(["updateDataFilter",[true],{"toDoFilter":{"sample":{"IFN":{"exact":["High","Low"]},"SNP":{"exact":Alleles_value}}}}]);
